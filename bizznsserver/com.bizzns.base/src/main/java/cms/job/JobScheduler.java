...
public class JobScheduler {
    ...
    @Property(value="cms@bizzns.com")
    public static final String EMAIL_FROM = "email.from";

    @Property(value="admin@bizzns.com")
    public static final String EMAIL_TO = "email.to";

    @Property(value="Bizzns CMS - Report")
    public static final String EMAIL_SUBJECT = "email.subject";

    private static final Logger log = LoggerFactory.getLogger(JobScheduler.class);

    protected void activate(ComponentContext componentContext) throws Exception {
        log.info("bizzns :: cms :: core :: JobScheduler :: activate");
    ...
    protected void deactivate(ComponentContext componentContext) throws Exception {
        log.info("bizzns :: cms :: core :: JobScheduler :: deactivate");         
