...
public class CloudExtension extends SlingAllMethodsServlet {
    ...
    protected void activate(ComponentContext ctx) {
        log.info("bizzns :: core :: CloudExtension :: activate called");
        try {
            /* TODO
    ...
    protected void deactivate(ComponentContext ctx) {
    	log.info("bizzns :: core :: CloudExtension :: deactivate called");
        if (session != null) {
            session.logout();
            session = null;
        }
    ...
    private void createTagCloud(SlingHttpServletRequest req, SlingHttpServletResponse resp) throws IOException, RepositoryException {        
        log.info("bizzns :: core :: CloudExtension :: createTagCloud called");
